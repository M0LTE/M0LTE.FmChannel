...
//
// Extracted from packet-net/pdn-soundmodem (GPL-3.0-or-later), where it was
// tests/Packet.SoundModem.Tests/Channel/FmChannel.cs, so that the modems measured through it can
// share one definition instead of copying it about. A second copy of a channel model is a second
// set of numbers.
...
/// microphone input, several kHz on a data port. This is the hard limit on how wide an audio-band
/// mode can be through a voice path.</param>
...
/// </summary>
/// <remarks>
/// <para><b>Why this is not a Watterson rig.</b> A Watterson model describes a linear
...
/// This is why pre/de-emphasis exists, and why a wideband audio mode - whose top
...
public sealed class FmChannel
{
    ...
    // spread and interpolated up - the standard construction for a fading path, applied
